...
//version 2
const findIndex = (list,ele) => list.findIndex((e, index) => {
    if (e._id === ele._id) return true
})

//test 1
let booking = { status: "pending", _id: "6055cb33062eb5153c089122", title: "title2", description: "test description", user: "id", team: "id" }
console.log("index >>> ", findIndex(bookings,booking))
//output : 1
...
console.log("index >>> ", findIndex(bookings,{ _id: id }))
//output : 2